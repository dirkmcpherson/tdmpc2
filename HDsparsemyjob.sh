#!/bin/bash
#SBATCH -J tdmpc2pusht_HDsps #job name
#SBATCH --time=01-12:00:00 #requested time (DD-HH:MM:SS)
...
#SBATCH --output=HDsps.%j.%N.out #saving standard output to file, %j=JOBID, %N=NodeName
#SBATCH --error=HDsps.%j.%N.err #saving standard error to file, %j=JOBID, %N=NodeName
...
python tdmpc2/train.py task=pusht obs=rgb demo_path='/cluster/tufts/shortlab/jstale02/tdmpc2/demonstrations/HD_0_sparse' force_sparse=true horizon=7
